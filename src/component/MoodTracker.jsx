...
const MoodTracker = () => {
    ...
    return (
        <div className="mood-tracker-container m-auto my-20 min-h-[30rem] max-h-[80vh] w-[30rem] shadow-lg shadow-slate-500 rounded-xl flex flex-col justify-between p-6 relative bg-[#091057] font-mono hover:rotate-360 hover:-translate-x-2 cursor-pointer">
